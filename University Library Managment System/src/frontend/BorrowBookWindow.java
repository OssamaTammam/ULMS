...
public class BorrowBookWindow extends javax.swing.JFrame implements Node {
    ...
    private void buttonBorrowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonBorrowActionPerformed
        ...
        Date borrowDate = fieldDateChooser.getDate();
        LocalDate borrowLDate = convertToLocalDateViaInstant(borrowDate);

        if (studentId.isEmpty() || bookId.isEmpty() || (borrowDate == null)) {
            JOptionPane.showMessageDialog(null, "Some fields are empty");
            flag = true;
        }
        int conditon = librarian.borrowBook(studentId, bookId, borrowLDate);
        if (conditon == -1 && flag == false) {
            JOptionPane.showMessageDialog(null, "Book doesn't exist");
        } else if (conditon == 1 && flag == false) {
            JOptionPane.showMessageDialog(null, "Student already borrowed this book");
        } else if (conditon == 0 && flag == false) {
            JOptionPane.showMessageDialog(null, "No copies left of this book");
        } else if (conditon == 2 && flag == false) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrowBookWindow(new LibrarianRole()).setVisible(true);
            }
        });
    }
